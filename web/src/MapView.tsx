...
interface Props {
  ...
  lngKey: string;
  labelKey: string;
  onPinClick?: (row: Record<string, unknown>) => void;
}
...
export function MapView({ data, latKey, lngKey, labelKey, onPinClick }: Props) {
  ...
  return <div ref={containerRef} style={{ height: 480, width: '100%', borderRadius: 8 }} />;
}
