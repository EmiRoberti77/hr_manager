...
export function Chat({ demoUsers, demoUser, setDemoUser, frame, onResetFrame, turns, sending, onSend, }) {
    ...
    return (_jsxs("aside", { className: "sidebar", children: [_jsxs("header", { children: [_jsx("h1", { children: "HR analytics" }), _jsx("div", { style: { fontSize: 12, color: '#6b7280' }, children: "Ask about headcount, holidays, joiners, individuals." })] }), _jsxs("div", { className: "demo-user", children: [_jsx("label", { children: "Signed in as (demo)" }), _jsx("select", { value: demoUser, onChange: (e) => setDemoUser(e.target.value), children: demoUsers.map((u) => (_jsxs("option", { value: u.email, children: [u.email, " \u2014 ", u.team] }, u.email))) })] }), _jsxs("div", { className: "context-frame", children: [_jsx("h2", { children: "Context frame" }), _jsxs("dl", { children: [_jsx("dt", { children: "Employee" }), _jsx("dd", { children: frame?.active_employee ?? '—' }), _jsx("dt", { children: "Team" }), _jsx("dd", { children: frame?.active_team ?? '—' }), _jsx("dt", { children: "Date range" }), _jsx("dd", { children: frame?.date_range ?? '—' })] }), _jsx("button", { onClick: onResetFrame, children: "Reset frame" })] }), _jsxs("div", { className: "transcript", ref: transcriptRef, children: [turns.length === 0 && (_jsx("div", { style: { color: '#9ca3af', fontSize: 13 }, children: "No messages yet. Try one of the suggestions below." })), turns.map((t, i) => (_jsxs("div", { className: `turn ${t.role}`, children: [t.role === 'user' ? '› ' : '', t.text] }, i))), sending && _jsx("div", { className: "turn assistant", children: "\u2026thinking" })] }), _jsx("div", { className: "suggestions", children: SUGGESTIONS.map((s) => (_jsx("button", { disabled: sending, onClick: () => onSend(s), children: s }, s))) }), _jsxs("div", { className: "composer", children: [_jsx("input", { value: draft, placeholder: "Ask anything about your team\u2026", onChange: (e) => setDraft(e.target.value), onKeyDown: (e) => {
                            if (e.key === 'Enter')
                                submit();
